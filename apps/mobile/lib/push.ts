...
//
// NOTE: expo-notifications is a native module — it only works in a dev build /
// production build (not in Expo Go on SDK 53+ for remote push). After adding it,
// run `npx expo prebuild` + a dev build (EAS) before push will deliver.
